...
public class AVTransmit2
{
	...
	//------------ Main ----------------------------------\
	//	The main waits for a UDP request from the client.
	//	It then gets the IP Address and begins to transmit
	//	the video feed.
	//------------------------------------------------------
	...
	public static void main(String [] args)
	{
		...
		if (ml != null)
		{
			...
			try
			{
				...
				//create space to receive the packet
				receivePacket =	new DatagramPacket(receiveData,
												receiveData.length);

				DatagramSocket serverSocket = new DatagramSocket(portnum);

				//waits to recieve connection request
				serverSocket.receive(receivePacket);

				//get client ip
				IPAddress = receivePacket.getAddress().getHostAddress();
				System.out.println("Transmitting to " + IPAddress + ":" + PortNum);
			}
			catch(Exception e){}

			// Create a audio transmit object with the specified params.
			AVTransmit2 at = new AVTransmit2(ml, IPAddress, PortNum, fmt);
			...
			System.err.println("Start transmission for 5 minutes...");
		...
		{
			System.err.println("No MediaLocator found\n");
		}
	}//--------------- End of Main ------------------------------------
     ...
     public static MediaLocator getMediaLocator()
    {
      ...
      MediaLocator mediaLocator = autoDetect().getLocator();
		return mediaLocator;
	}
	...
	//							AUTO DETECT
	//*****************************************************************
   	public static CaptureDeviceInfo autoDetect ( )
   	{
